  ...
  render() {
    return (
      <div className="install-modal-content">
        ...
        <div className="modal-install-instruction"><span className="modal-install-instruction-number"></span>Install litmus Operator, a tool for for injecting chaos experiments on Kubernetes</div>
        <div className="modal-code">       <a href="https://github.com/litmuschaos/chaos-operator/blob/master/README.md"> https://github.com/litmuschaos/chaos-operator/blob/master/README.md </a></div>
