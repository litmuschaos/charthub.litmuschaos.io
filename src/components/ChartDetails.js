      ...
      <div className={isCollapsed}>
        ...
        <div className="chart-details-uses-explanation">
          <div className="d-flex item-block"> 
            <i className="mi-settings dark-gray"></i> 
            <div className="d-flex flex-column items"> <span className="uses-explanation-title"> Maturity</span>
              {this.props.charts.spec.maturity}
              </div>
          </div>
          <div className="d-flex item-block">
            <i className="mi-link dark-gray"></i>  
            <div className="d-flex flex-column items"> <span className="uses-explanation-title"> Useful links</span>
          ...
          <div className="d-flex item-block"> <i className="mi-application dark-gray"></i>
            <div className="d-flex flex-column items"> <span className="uses-explanation-title"> Version</span>
              {this.props.charts.metadata.version}
            </div>
          </div>
          <div className="d-flex item-block"> <i className="mi-link dark-gray"></i> 
          <div className="d-flex flex-column items"> <span className="uses-explanation-title"> Repository</span>
